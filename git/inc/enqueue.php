...
function wasi_css_js_file_calling(){
...
add_action('wp_enqueue_scripts', 'wasi_css_js_file_calling');


// Google Fonts Enqueue
function wasi_add_google_fonts(){
...
add_action('wp_enqueue_scripts', 'wasi_add_google_fonts');
